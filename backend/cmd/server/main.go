...
func main() {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     "http://localhost:5173, http://127.0.0.1:5173, https://saphabot.me, http://saphabot.me",
		AllowHeaders:     "Origin, Content-Type, Accept, Authorization, X-Requested-With, X-Organization-ID,X-User-ID, X-Encrypted-Token",
